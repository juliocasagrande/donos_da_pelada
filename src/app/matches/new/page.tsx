...
export default async function NewMatchPage() {
  ...
  const [allowAmistoso, defaults, recentLocations] = await Promise.all([
    isPeladaIdPro(admin.peladaId!),
    getMatchDefaults(admin.peladaId!),
    getRecentLocations(admin.peladaId!)
  ]);
